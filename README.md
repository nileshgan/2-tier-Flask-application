...
## Flask App with MySQL Docker Kubernetes Setup ##

This is a simple Flask app that interacts with a MySQL database. The app allows users to submit messages, which are stored in the database and displayed on the frontend webpage.

## Prerequisites ##

Before you begin, make sure you have the following installed:

- Docker (for creating the containers)
...
- If you encounter issues, check Docker container logs and error messages for troubleshooting.
